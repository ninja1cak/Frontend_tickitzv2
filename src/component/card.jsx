        ...
        <div className='relative '>
            <div className='group bg-black rounded-md'>
                <img className='shadow-xl h-64 w-full sm:h-96 group-hover:opacity-25 hover:opacity-25 object-center' src={banner} alt="movie-banner" />
                    ...
                    <div className='invisible group-hover:visible flex flex-col absolute top-32 left-0 right-0 mx-auto justify-center items-center'>
                        <button className=' btn bg-inherit text-white hover:text-slate-500 border-2 w-20 md:w-44 capitalize mb-5'>Details</button>
                        <button className='bg-blue-700 hover:bg-white hover:text-blue-700 text-white font-bold py-3 px-4 rounded-lg text w-20 md:w-44 capitalize'>Buy Tickets</button>
                    </div>
